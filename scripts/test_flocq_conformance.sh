...
for fixture in BooleanComparison RawIEEERounding RawOverflow SingleNaNArithmetic SingleNaNHelpers MultiplicationErrorGrid DoubleRoundingWitness SingleNaNValidity RelativeErrorGrid \
...
for fixture in BooleanComparison RawIEEERounding RawOverflow SingleNaNArithmetic SingleNaNHelpers NativeSingleNaNArithmetic MultiplicationErrorGrid DoubleRoundingWitness SingleNaNValidity RelativeErrorGrid ExactArithmeticLaws RoundingOracle IntegerRounding; do
